...
#+TAGS: ignore(i) TEST(t) DEPRECATED(d) noexport(n) export(e)
#+CATEGORY: TwitterVis
...
[[#exp20170822165129][{2017-08-22 Ter} Experiment =bench_insert_and_scan=]]
...
**** RERUN [2017-09-15 Sex] Experiment =bench_insert_and_scan= :exp20170919161448:
***** Setup                                                    :noexport:
- [X] Create a direcorty for this experiment 
  #+begin_src sh :results output :exports both :session template
  set -e
...
**** DONE [2017-09-15 Sex] Twitter Dataset =bench_insert_and_scan= :exp20170923193058:
***** Setup                                                    :noexport:
- [X] Create a direcorty for this experiment 
  #+begin_src sh :results output :exports both :session template
  set -e
...
**** ANALYSIS [2017-09-07 Qui] =bench_queries_region= V.2 :exp20170907145711:
...
**** DONE [2017-09-15 Sex] =bench_queries_region= V.3    :exp20170915143003:
...
**** TODO [2017-09-23 Sáb] =bench_queries_region= Twitter Dataset
...
**** ANALYSIS [2017-09-14 Qui] =bench_insert_remove_count= :exp20170914091842:
