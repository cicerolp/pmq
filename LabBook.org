...
**** TODO [2017-10-12 Qui] Twitter Dataset - Varying T :exp20171012184842:
...
**** TODO [2017-10-16 Seg] Twitter Dataset - Varying T and Elt Size :exp20171016155353:
...
#+end_src
  ...
  #+RESULTS:
  : 
  : sh-4.4$ sh-4.4$ sh-4.4$ sh-4.4$ ./data/cicero/exp20171111160707
  
- [X] Use the template to run your experiment
  
  #+begin_src sh :results output raw :exports both :session template
  git log -1 origin/exp20171016155353--oneline | cat
  git show exp20171016155353:./data/cicero/exp20171016155353/exp.org > ${expFolder}/exp.org
  ...
  #+RESULTS:
  21cd8b2 image file
  sh-4.4$ sh-4.4$ [[./data/cicero/exp20171111160707/exp.org]]
