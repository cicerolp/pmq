...
public:
   ...
   void query_tile(pma_struct* pma, const std::vector<spatial_t>& tile, json_ctn& subset) const;
      
private:
   void aggregate_tile(pma_struct* pma, uint32_t zoom, json_ctn& subset) const;
